...
class DUTAdder(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # all Pins
        self.io_a = xsp.XPin(xsp.XData(64, xsp.XData.In), self.event)
        self.io_b = xsp.XPin(xsp.XData(64, xsp.XData.In), self.event)
        self.io_cin = xsp.XPin(xsp.XData(0, xsp.XData.In), self.event)
        self.io_sum = xsp.XPin(xsp.XData(64, xsp.XData.Out), self.event)
        self.io_cout = xsp.XPin(xsp.XData(0, xsp.XData.Out), self.event)


        # BindDPI
        self.io_a.BindDPIPtr(self.dut.GetDPIHandle("io_a", 0), self.dut.GetDPIHandle("io_a", 1))
        self.io_b.BindDPIPtr(self.dut.GetDPIHandle("io_b", 0), self.dut.GetDPIHandle("io_b", 1))
        self.io_cin.BindDPIPtr(self.dut.GetDPIHandle("io_cin", 0), self.dut.GetDPIHandle("io_cin", 1))
        self.io_sum.BindDPIPtr(self.dut.GetDPIHandle("io_sum", 0), self.dut.GetDPIHandle("io_sum", 1))
        self.io_cout.BindDPIPtr(self.dut.GetDPIHandle("io_cout", 0), self.dut.GetDPIHandle("io_cout", 1))


        # Add2Port
        self.xport.Add("io_a", self.io_a.xdata)
        self.xport.Add("io_b", self.io_b.xdata)
        self.xport.Add("io_cin", self.io_cin.xdata)
        self.xport.Add("io_sum", self.io_sum.xdata)
        self.xport.Add("io_cout", self.io_cout.xdata)
